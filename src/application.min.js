...
(function() {
    function d(ax, at) {
        function av(x) {
            ...
            var v;
            if ("bug-string-char-index" == x) {
                v = "a" != "a" [0]
            } else {
                if ("json" == x) {
                    v = av("json-stringify") && av("json-parse")
                } else {
                    var t;
                    if ("json-stringify" == x) {
                        v = at.stringify;
                        var w = "function" == typeof v && aq;
                        if (w) {
                            (t = function() {
                                return 1
                            }).toJSON = t;
                            try {
                                w = "0" === v(0) && "0" === v(new ao) && '""' == v(new aw) && v(am) === aj && v(aj) === aj && v() === aj && "1" === v(t) && "[1]" == v([t]) && "[null]" == v([aj]) && "null" == v(null) && "[null,null,null]" == v([aj, am, null]) && '{"a":[1,true,false,null,"\\u0000\\b\\n\\f\\r\\t"]}' == v({
                                    a: [t, !0, !1, null, "\x00\b\n\f\r\t"]
                                }) && "1" === v(null, t) && "[\n 1,\n 2\n]" == v([1, 2], null, 1) && '"-271821-04-20T00:00:00.000Z"' == v(new ar(-8640000000000000)) && '"+275760-09-13T00:00:00.000Z"' == v(new ar(8640000000000000)) && '"-000001-01-01T00:00:00.000Z"' == v(new ar(-62198755200000)) && '"1969-12-31T23:59:59.999Z"' == v(new ar(-1))
                            } catch (s) {
                                w = !1
                            }
                        }
                    ...
                    if ("json-parse" == x) {
                        ...
                        if ("function" == typeof v) {
                            try {
                                if (0 === v("0") && !v(!1)) {
                                    t = v('{"a":[1,true,false,null,"\\u0000\\b\\n\\f\\r\\t"]}');
                                    var p = 5 == t.a.length && 1 === t.a[0];
                                    if (p) {
                                        try {
                                            p = !v('"\t"')
                                        } catch (u) {}
        ...
        if (!av("json")) {
            ...
            if (!aq) {
                var ag = ab.floor,
                    ...
                    an = function(l, p) {
                        return aa[p] + 365 * (l - 1970) + ag((l - 1969 + (p = +(1 < p))) / 4) - ag((l - 1901 + p) / 100) + ag((l - 1601 + p) / 400)
                    }
            }(al = ai.hasOwnProperty) || (al = function(l) {
                var q = {},
                    p;
                (q.__proto__ = null, q.__proto__ = {
                    toString: 1
                }, q).toString != am ? al = function(r) {
                    var s = this.__proto__;
                    r = r in (this.__proto__ = null, this);
                    this.__proto__ = s;
                    return r
                } : (p = q.constructor, al = function(r) {
                    var s = (this.constructor || p).prototype;
                    return r in this && !(r in s && this[r] === s[r])
                });
                q = null;
                return al.call(this, l)
            });
            au = function(p, t) {
                var r = 0,
                    l, q, s;
                ...
                l = q = null;
                r ? au = 2 == r ? function(v, y) {
                    var x = {},
                        u = "[object Function]" == am.call(v),
                        w;
                    for (w in v) {
                        u && "prototype" == w || al.call(x, w) || !(x[w] = 1) || !al.call(v, w) || y(w)
                    }
                } : function(v, y) {
                    var x = "[object Function]" == am.call(v),
                        u, w;
                    for (u in v) {
                        x && "prototype" == u || !al.call(v, u) || (w = "constructor" === u) || y(u)
                    }(w || al.call(v, u = "constructor")) && y(u)
                } : (q = "valueOf toString toLocaleString propertyIsEnumerable isPrototypeOf hasOwnProperty constructor".split(" "), au = function(v, y) {
                    var x = "[object Function]" == am.call(v),
                        u, w = !x && "function" != typeof v.constructor && i[typeof v.hasOwnProperty] && v.hasOwnProperty || al;
                    for (u in v) {
                        x && "prototype" == u || !w.call(v, u) || y(u)
                    }
                    for (x = q.length; u = q[--x]; w.call(v, u) && y(u)) {}
                });
                return au(p, t)
            };
            if (!av("json-stringify")) {
                var n = {
                    ...
                    af = function(l, p) {
                        return ("000000" + (p || 0)).slice(-l)
                    },
                    N = function(p) {
                        for (var u = '"', l = 0, q = p.length, r = !ap || 10 < q, t = r && (ap ? p.split("") : p); l < q; l++) {
                            var s = p.charCodeAt(l);
                            switch (s) {
                                case 8:
                                case 9:
                                case 10:
                ...
                at.stringify = function(y, w, x) {
                    var s, u, p, v;
                    if (i[typeof w] && w) {
                        if ("[object Function]" == (v = am.call(w))) {
                            u = w
                        } else {
                            if ("[object Array]" == v) {
                                p = {};
                                for (var t = 0, r = w.length, q; t < r; q = w[t++], (v = am.call(q), "[object String]" == v || "[object Number]" == v) && (p[q] = 1)) {}
                            }
                        }
                    }
                    if (x) {
                        if ("[object Number]" == (v = am.call(x))) {
                            if (0 < (x -= x % 1)) {
                                for (s = "", 10 < x && (x = 10); s.length < x; s += " ") {}
                            }
                        } else {
                            "[object String]" == v && (s = 10 >= x.length ? x : x.slice(0, 10))
                        }
                    }
                    return Z("", (q = {}, q[""] = y, q), u, p, s, "", [])
                }
            }
            if (!av("json-parse")) {
                var m = aw.fromCharCode,
                    ...
                    ac = function() {
                        for (var l = ae, u = l.length, s, q, r, p, t; az < u;) {
                            switch (t = l.charCodeAt(az), t) {
                                case 9:
                                case 10:
                                case 13:
                                case 32:
                                ...
                                case 58:
                                case 44:
                                    return s = ap ? l.charAt(az) : l[az], az++, s;
                                case 34:
                                    s = "@";
                                    for (az++; az < u;) {
                                        if (t = l.charCodeAt(az), 32 > t) {
                                            ay()
                                        } else {
                                            if (92 == t) {
                                                switch (t = l.charCodeAt(++az), t) {
                                                    ...
                                                    case 117:
                                                        q = ++az;
                                                        for (r = az + 4; az < r; az++) {
                                                            t = l.charCodeAt(az), 48 <= t && 57 >= t || 97 <= t && 102 >= t || 65 <= t && 70 >= t || ay()
                                                        }
                                                        s += m("0x" + l.slice(q, az));
                                                        break;
                                                    default:
                                    ...
                                    if (34 == l.charCodeAt(az)) {
                                        return az++, s
                                    }
                                    ay();
                                default:
                                    q = az;
                                    45 == t && (p = !0, t = l.charCodeAt(++az));
                                    if (48 <= t && 57 >= t) {
                                        for (48 == t && (t = l.charCodeAt(az + 1), 48 <= t && 57 >= t) && ay(); az < u && (t = l.charCodeAt(az), 48 <= t && 57 >= t); az++) {}
                                        if (46 == l.charCodeAt(az)) {
                                            for (r = ++az; r < u && (t = l.charCodeAt(r), 48 <= t && 57 >= t); r++) {}
                                            r == az && ay();
                                            az = r
                                        }
                                        t = l.charCodeAt(az);
                                    ...
                                    p && ay();
                                    if ("true" == l.slice(az, az + 4)) {
                                        return az += 4, !0
                                    }
                                    if ("false" == l.slice(az, az + 5)) {
                                        return az += 5, !1
                                    }
                                    if ("null" == l.slice(az, az + 4)) {
                                        return az += 4, null
                                    }
                                    ay()
                            }
                        ...
                        if ("string" == typeof p) {
                            ...
                            if ("{" == p) {
                                for (q = {};; l || (l = !0)) {
                                    ...
                                    l && ("," == p ? (p = ac(), "}" == p && ay()) : ay());
                                    "," != p && "string" == typeof p && "@" == (ap ? p.charAt(0) : p[0]) && ":" == ac() || ay();
                                    q[p.slice(1)] = Y(ac())
                                }
                                return q
                            }
                    ...
                    o = function(p, l, q) {
                        q = F(p, l, q);
                        q === aj ? delete p[l] : p[l] = q
                    },
                    F = function(p, l, s) {
                        var q = p[l],
                            r;
                        if ("object" == typeof q && q) {
                            if ("[object Array]" == am.call(q)) {
                                for (r = q.length; r--;) {
                                    o(q, r, s)
                                }
                            } else {
                ...
                at.parse = function(l, r) {
                    ...
                    "$" != ac() && ay();
                    az = ae = null;
                    return r && "[object Function]" == am.call(r) ? F((p = {}, p[""] = q, p), "", r) : q
                }
            }
        }
        at.runInContext = d;
    ...
    var g = typeof define === "function" && define.amd,
        ...
        h = i[typeof exports] && exports && !exports.nodeType && exports,
        b = i[typeof window] && window || this,
        j = h && i[typeof module] && module && !module.nodeType && "object" == typeof global && global;
    !j || j.global !== j && j.window !== j && j.self !== j || (b = j);
    if (h && !g) {
        d(b, h)
    } else {
        var f = b.JSON,
...
$ = {
    isBrowserCompatible: function() {
        return window.localStorage !== null && Array.prototype.map && Array.prototype.filter && document.querySelector && document.querySelectorAll && window.btoa && window.atob
    },
    domReady: function(a) {
    ...
    methodize: function(b) {
        var a = b.split(/\-|\_/).map(function(c) {
            return $.titleize(c)
        });
        return a.join("").replace(/\#|\./, "")
    },
    constantize: function(b) {
        var a = b.replace(/\#|\./, "").split(/\-|\_/).map(function(c) {
            return $.titleize(c)
        });
        return a.join("")
    },
    setSelectBoxSelected: function(a, b) {
        $.each(a.querySelectorAll("option"), function(c, d) {
            d.selected = false
        });
        a.querySelector("option[value=" + b + "]").selected = true
    },
    freeze: function(b) {
        var c, a;
        Object.freeze(b);
        for (a in b) {
            c = b[a];
            if (!b.hasOwnProperty(a) || !(typeof c === "object") || Object.isFrozen(c)) {
                continue
            }
            $.freeze(c)
        }
...
window.Animations.Attack = {
    play: function(d) {
        var b = window.currentGame.player;
        var a = window.currentBattle.enemy;
        var c = null;
        move(b.battleGraphic).x(a.enemyInformation.player_position.x).y(a.enemyInformation.player_position.y).duration("0.4s").ease("in").end();
        clearTimeout(c);
        c = setTimeout(function() {
            move(b.battleGraphic).x(0).duration("0.3s").ease("out").end(function() {
                window.currentBattle.controls.enable.call(window.currentBattle);
                a.looseHealth(b.calculateDamage())
            });
            clearTimeout(c)
        }, 500)
    }
...
window.Animations.Magic = (function() {
    ...
    var a = {
        fire: {
            play: function() {
                h = window.Magic.fire;
                c = window.currentBattle.enemy;
                e = d("fire");
                j = setTimeout(g, h.castTime)
            }
        }
    };

    function g() {
        dom.find("#battle-sequence-popup .field .player").appendChild(e);
        window.currentGame.player.increaseMagic(h.mp);
        b();
        f()
    }

    function b() {
        move(e).set("left", "0px").set("top", "0px").end()
    }

    function f() {
        move(e).set("left", c.enemyInformation.player_position.x + "px").set("top", c.enemyInformation.player_position.y + "px").duration(500).ease("in").end(i)
    }

    function i() {
        window.currentBattle.controls.enable.call(window.currentBattle);
        c.looseHealth(h.damage);
        e.remove();
        clearTimeout(j)
    }
...
window.Animations.FishSpawner = {
    spawn: function(a) {
        var b = Math.round(Math.random() * 10000) + 15000;
        move(a).duration(b).end();
        move(a).set("left", (window.screen.width + 100) + "px").ease("in").duration(b).end(function() {
            a.remove()
        })
    }
};
window.Animations.EvilPortrait = {
    start: function() {
        ...
        $.each(this.elements, a.animate.bind(a))
    },
    animate: function(c, b) {
        var a = this;
        $.each(this.colours, function(e, d) {
            a.colorTimeout = setTimeout(a.animateRow.bind(a, b, c, e, d), e * 2000)
        })
    },
    animateRow: function(e, f, a, c) {
        var b = this;

        function d() {
            return (a == (b.colours.length - 1) && f == (b.elements.length - 1))
        }
        move(e).set("color", c).duration(3000).end(function() {
            if (d()) {
                window.currentLevel.levelModule.initiateBossFight()
            }
        });
        if (d()) {
            clearTimeout(b.colorTimeout)
        }
    }
};
Flash.prototype = {
...
function Popup(b, a, c) {
    this.popup = dom.findId(b);
    this.closeButton = dom.findId(b + "-close");
    this.openCallback = a || function() {};
    this.closeCallback = c || function() {};
...
Bar.prototype = {
    ...
    fillBar: function() {
        move(this.bar).set("width", "100%").ease("in").duration(this.interval).end(this.callback)
    },
    resetBar: function(a) {
        move(this.bar).duration(0).set("width", "0px").end();
        this.setCallback(a);
        this.fillBar()
    },
...
function Bar(b, a) {
    this.bar = b;
    this.domBar = dom.find(b).parentNode;
    this.interval = a;
    this.fillBarCallback
}
StatBar.prototype = {
    update: function(a) {
        this.currentStatAmount = a;
        this.currentAmount.innerHTML = a;
        this.innerBar.style.width = this.calculatePercentage() + "%"
    },
    set: function(a, b) {
        this.currentStatAmount = a;
        this.totalStatAmount = b;
        this.currentAmount.innerHTML = a;
        this.total.innerHTML = b;
        this.update(a)
    },
...
function StatBar(c, b, d, a) {
    this.barScope = dom.find(c);
    this.currentAmount = this.barScope.querySelector(b);
    this.total = this.barScope.querySelector(d);
    this.innerBar = this.barScope.querySelector(a)
}
window.Levels = {
    lonely_island: ["underwater_shack"],
    squirrel_city: ["squirrel_city_first_level_house", "squirrel_city_second_level_house", "squirrel_city_attic_level_house"],
    cliffhill_town: [],
...
window.LonelyIsland = {
    addShark: function() {
        ...
        $.each(document.querySelectorAll("span.big-shark-part"), function(a, b) {
    ...
    showFish: function() {
        ...
        var a = new Character("fish", {
            initialize: function() {
                var b = this;
                var c = dom.findId("fish-seller-buy-button");
                this.itemsForSale = document.querySelectorAll(".sell-items li");
                this.initialfishSellerPopUp = new Popup("fish-seller-popup");
                this.fishBuyPopUp = new Popup("fish-seller-buy-popup", function() {
                    b.checkFishInventory()
                }, function() {
                    b.initialfishSellerPopUp.hide()
                });
                c.onclick = function() {
                    b.fishBuyPopUp.show()
                };
            ...
            checkFishInventory: function() {
                $.each(this.itemsForSale, function(b, c) {
                    var d = c.getAttribute("name");
                    if (window.currentGame.player.canBuyItem(d)) {
            ...
            addBuyListeners: function() {
                ...
                $.each(this.itemsForSale, function(c, d) {
                    d.onclick = function() {
                        ...
                        window.currentGame.player.buy(e);
                        b.checkFishInventory()
                    }
                })
            }
    ...
    showBuildBridgeButton: function() {
        var b = new Popup("island-bridge-popup", window.LonelyIsland.enableBuildBridgeButton);
        var a = dom.findId("island-bridge");
    ...
    enableBuildBridgeButton: function() {
        if (GameData.player.woods >= 100 && !window.currentGame.checkProgressOn("enable_build_bridge_button") && window.currentGame.checkProgressOn("show_bottle")) {
            var a = dom.find("#island-bridge-popup #build-island-bridge");
    ...
    disableSeashell: function() {
        ...
        var a = dom.find("#game-levels #lonely_island #island-seashell");
    ...
    enableWhirlpool: function() {
        var a = dom.find("#game-levels #lonely_island #island-whirlpool");
...
window.UnderwaterShack = {
    ...
    initialize: function() {
        var a = dom.find("#island-whirlpool-2");
        a.onclick = function() {
    ...
    spawnFish: function() {
        var a = this;
        this.fishSpawnInterval = setInterval(function() {
            if (a.fishCount() <= 5) {
                var b = a.buildFish();
                dom.findId("underwater_shack").appendChild(b);
                window.Animations.FishSpawner.spawn(b)
            }
        }, this.calculateIntervalNumber())
    },
    buildFish: function() {
        var a = this.pickFish().name;
        var b = dom.find(".enemies #" + a).cloneNode(true);
        b.className = "us-fish";
        b.id = "fish-" + this.fishCount();
        b.style.top = (Math.round(Math.random() * 370) + 90) + "px";
        b.onclick = window.BattleInitializer.start.bind(this, ("btl-" + a), null, this.spawnFish.bind(this));
        return b
    },
    pickFish: function() {
        var c = [];
        for (var b = 0; b < this.FISHES.length; b++) {
            for (var a = 0; a < this.FISHES[b].probability; a++) {
                c.push(this.FISHES[b])
            }
        }
        picked_fish = Math.round(Math.random() * (c.length - 1));
        return c[picked_fish]
    },
    fishCount: function() {
    ...
    destroyFish: function() {
        $.each(dom.find(".us-fish", true), function(b, a) {
            a.remove()
        })
    },
    destroy: function() {
...
window.SquirrelCity = {
    ...
    openDoor: function() {
        var a = dom.find("#squirrel-warning button#enter-the-house");
        var b = new Popup("squirrel-warning");
        b.show();
        a.onclick = function() {
    ...
    grabSpear: function() {
        if (!window.currentGame.checkProgressOn("squirrel_house_spear")) {
            ...
            var a = new Weapon("spear");
            window.currentGame.player.inventory.addItem("weapons", a);
            window.SquirrelCity.disableSpear()
        }
    },
    disableSpear: function() {
        $.each(document.querySelectorAll(".squirrel-city-spear-wall"), function(a, b) {
            b.innerHTML = "&nbsp;";
...
window.SquirrelCityAtticLevelHouse = {
    ...
    hidePainting: function() {
        $.each(dom.find(".evil-painting .inner-painting", true), function(b, a) {
            a.innerHTML = "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"
        })
    },
...
window.LevelClickMethods = {};
window.LevelClickMethods.LonelyIsland = {
    islandSeashell: function() {
        window.currentStats.increaseStat("seashell", 1, window.currentGame.callbacks.statsCallbacks.seashell.performCallback)
    },
...
var ExperienceCallbacks = (function() {
    ExperienceCallbacks = {
        increaseExperience: function(e) {
            GameData.player.experience += e;
            b()
        }
    };
    ...
    function b() {
        $.each(c(), function(e, f) {
            if (GameData.player.experience > parseInt(f) && GameData.player.experience_rewards.indexOf(f) === -1) {
                a(f)
            }
        })
    }
    ...
    function c() {
        return Object.keys(ExperiencePoints).filter(function(e) {
            return parseInt(e) <= GameData.player.experience
        })
    }

    function a(g) {
        GameData.player.experience_rewards.push(g);
        var e = ExperiencePoints[g];
        for (var f in e) {
    ...
    var d = {
        hp: function(e) {
            GameData.player.hp[1] += e
        },
        mp: function(e) {
            GameData.player.mp[1] += e
        },
        speed: function(e) {
            GameData.player.battle_timeout += e
        }
    };
...
StatsCallbacks = {
    seashell: {
        performCallback: function(a) {
            if (a > 0 && !window.currentGame.checkProgressOn("show_fish")) {
                window.LonelyIsland.showFish()
            } else {
                if (a > 19 && !window.currentGame.checkProgressOn("show_bottle")) {
                    window.LonelyIsland.showMessageInABottle()
                } else {
                    if (a > 99 && !window.currentGame.checkProgressOn("hide_seashell")) {
                        window.LonelyIsland.disableSeashell()
                    } else {
                        if (a > 999 && !window.currentGame.checkProgressOn("show_shark")) {
    ...
    wood: {
        performCallback: function(a) {
            if (a > 0 && !window.currentGame.checkProgressOn("show_build_bridge_button")) {
...
var LoadCallbacks = (function() {
    LoadCallbacks = {
        ...
        show_stat: function(a) {
            var c = dom.findId(a + "s");
            var b = dom.findId(a + "-count");
            c.style.display = "inline-block";
            b.innerHTML = GameData.player[a + "s"]
        },
        setupInventory: function() {
            window.currentGame.player.inventory.checkInventory();
            for (var a in window.GameData.player.inventory) {
                $.each(window.GameData.player.inventory[a], function(b, c) {
                    if (window.currentGame.callbacks.loadCallbacks.inventory[c + "_callback"]) {
                        window.currentGame.callbacks.loadCallbacks.inventory[c + "_callback"]()
                    }
                    new InventoryItem(c, a).add()
                })
            }
        },
...
function Character(b, a) {
    this.character = dom.findId(b);
    this.characterType = this.character.className;
    this.toBeRemovedSpan = dom.findId(b + "-remove");
    this.methods = a
}
window.ClickAreas = {
    lonely_island: ["#island-seashell", "#island-bridge", "#battle-big-shark", "#island-whirlpool"],
    underwater_shack: ["#island-whirlpool"],
    squirrel_city: ["#mysterious-squirrel", "#haunted-house-door"],
    squirrel_city_first_level_house: [".door-squirrel-city-house", "#squirrel-city-goto-first-level"],
    squirrel_city_second_level_house: ["#squirrel-city-goto-second-level", "#squirrel-city-goto-ground-level", ".squirrel-city-spear-wall", ".squirrel-house-closet"],
    squirrel_city_attic_level_house: ["#squirrel-city-goto-first-level-back", "#add-magical-fire-spell"]
};
...
window.Armors = {
    clown: {
        ...
        graphic: ["<0> ", "/[*]\\", " / \\"],
        large_graphic: ["      { }      ", "      /*\\      ", "     /_*_\\     ", "    <('.')>    ", "    /[>.<]\\    ", "   C [___] D   ", "    /  Y  \\    ", "   _\\__|__/_   ", "  (___/ \\___)  "]
    },
    none: {
        title: "",
        description: "",
...
window.Items = {
    remove: function(b) {
        dom.find("#inventory-stash .items #" + b).remove();
        if (window.currentBattle) {
            dom.find(".battle-sequence-interface .items #" + b).remove()
        }
        var a = GameData.player.inventory.items.indexOf(b);
        GameData.player.inventory.items.splice(a, 1)
    },
    potion: {
        title: "Potion",
...
$.freeze(window.Magic);
Stats.prototype = {
    increaseStat: function(c, a) {
        var b = dom.findId(c + "s");
        var d = dom.findId(c + "-count");
        b.style.display = "inline-block";
        window.currentStats.add(c + "s", a);
        if (window.currentGame.callbacks.statsCallbacks[c].performCallback) {
            window.currentGame.callbacks.statsCallbacks[c].performCallback(GameData.player[c + "s"])
        }
        d.innerHTML = GameData.player[c + "s"]
    },
    add: function(b, a) {
        GameData.player[b] += a
    }
...
var GameMap = (function() {
    d.prototype = {
        ...
        enableMapSpot: function(f) {
            var e = this;
            var g = this.findMapSpot(f);
            g.innerHTML = "O";
            g.classList.add("enabled");
            g.onclick = function() {
                window.currentGame.levels[f].addToGame();
                e.popUp.hide();
                window.currentGame.inventoryPopUp.hide()
            }
        },
        disableMapSpot: function(e) {
            var f = this.findMapSpot(e);
            f.innerHTML = "X";
            f.classList.remove("enabled");
            f.onclick = null
        },
        findMapSpot: function(e) {
            return this.currentMap.querySelector("#" + e + ".map-place")
        },
        findOnMap: function(e) {
            return this.currentMap.querySelector(e)
        }
    };
    ...
    function c() {
        a.bind(this)();
        this.currentMap = b.bind(this)();
        this.currentMap.style.display = "block"
    }

    function a() {
        var e = dom.find("#map-popup .inner pre");
        $.each(e, function(f, g) {
    ...
    function d() {
        this.currentMap = b.bind(this)();
        this.popUp = new Popup("map-popup", c.bind(this))
    }
    return d
})();
Graphic.prototype = {
    addChild: function(c) {
        var b = dom.findId("game-level");
        var a = document.createElement("PRE");
        a.innerHTML = this.asciiString;
        b.appendChild(a)
    }
};

function Graphic(a) {
    this.asciiString = a.join("\n")
}
Inventory.prototype = {
    ...
    hasSomethingInInventory: function() {
        var a = this.getInventory();
        return (a.items.length > 0 || a.weapons.length > 0 || a.armors.length > 0 || a.magic.length > 0 || a.skills.length > 0)
    },
    ...
    setupInventoryButton: function() {
        var a = dom.findId("open-inventory-button");
    ...
    setSelectedWeapon: function(b) {
        var a = typeof(b) == "string" ? b : b.target.value;
        $.setSelectBoxSelected(this.weaponSelectBox, a);
        window.currentGame.player.setCurrentWeapon(a)
    },
    setSelectedArmor: function(b) {
        var a = typeof(b) == "string" ? b : b.target.value;
        $.setSelectBoxSelected(this.armorSelectBox, a);
        window.currentGame.player.setCurrentArmor(a)
    },
    updateGraphicalWeaponPreview: function(a) {
        var b = dom.find("#inventory-stash .weapons .weapon-preview span", true);
        $.each(window.Weapons[a].large_graphic, function(d, c) {
            b[d].innerHTML = c
        })
    },
    updateGraphicalArmorPreview: function(b) {
        var a = dom.find("#inventory-stash .armors .armor-preview span", true);
        $.each(window.Armors[b].large_graphic, function(d, c) {
            a[d].innerHTML = c
        })
    },
    addItem: function(a, b) {
        GameData.player.inventory[a].push(b.identifier);
        b.add();
        this.checkInventory()
    }
};
...
var InventoryItem = (function() {
    ...
    d.prototype = {
        add: function() {
            this.item = b[this.itemScope].call(this);
            dom.find("#inventory-stash ." + a.call(this)).appendChild(this.item)
        }
    };

    function c() {
        var e = $.titleize(this.itemScope);
        return window[e][this.identifier]
    }
    ...
    b = {
        items: function() {
            ...
            e.id = this.identifier;
            e.innerHTML = this.itemOptions.title;
            e.title = this.itemOptions.description;
            e.onclick = this.itemOptions.use;
            return e
        },
        weapons: function() {
...
BattleItem.prototype = {
    ...
    add: function() {
        ...
        dom.find("#battle-sequence-popup ." + this.itemScope + " ul.list").appendChild(this.item)
    },
    isExcluded: function() {
    ...
    createItems: function() {
        ...
        a.id = this.identifier;
        a.innerHTML = this.itemOptions.title;
        a.title = this.itemOptions.description;
        a.onclick = this.itemOptions.use;
        return a
    },
    ...
    createMagic: function() {
        ...
        a.title = this.itemOptions.description;
        a.value = this.identifier;
        a.onclick = this.itemOptions.cast;
        return a
    },
    getItemOptions: function() {
        var a = $.titleize(this.itemScope);
        return window[a][this.identifier]
    }
};

function BattleItem(a, b) {
    this.identifier = a;
    this.itemScope = b;
...
var Player = (function() {
    a.prototype = {
        buy: function(c) {
            var d = sellPrices[c];
            if (GameData.player[d.type] >= d.value) {
                var b = d.type.substring(0, d.type.length - 1);
                window.currentStats.increaseStat(c, 1);
                window.currentStats.increaseStat(b, (d.value * -1))
            }
        },
        canBuyItem: function(b) {
            var c = GameData.player[sellPrices[b].type];
            return c >= sellPrices[b].value
        },
        attack: function() {
            window.currentBattle.eventEngine.add({
        ...
        magicAttack: function(b) {
            window.currentBattle.eventEngine.add({
                type: "player_battle_move",
                message: "You cast " + b,
                perform: window.Animations.Magic[b].play
            })
        },
        calculateDamage: function() {
            return GameData.player.attack_damage * this.weapon().damage
        },
        looseHealth: function(b) {
            GameData.player.hp[0] -= Math.round(b);
        ...
        increaseHealth: function(b) {
            GameData.player.hp[0] += b;
        ...
        increaseMagic: function(b) {
            GameData.player.mp[0] += b;
        ...
        setCurrentWeapon: function(b) {
            window.GameData.player.weapon = b;
            this.updateWeaponGraphics(b)
        },
        updateWeaponGraphics: function(b) {
            var c = this.graphic.querySelectorAll(".weapon");
            $.each(window.Weapons[b].graphic, function(e, d) {
                c[e].innerHTML = d
            });
            this.inventory.updateGraphicalWeaponPreview(b)
        },
        setCurrentArmor: function(b) {
            window.GameData.player.armor = b;
            this.updateArmorGraphics(b)
        },
        armor: function() {
        ...
        updateArmorGraphics: function(c) {
            var b = this.graphic.querySelectorAll(".armor");
            $.each(window.Armors[c].graphic, function(e, d) {
                b[e].innerHTML = d
            });
            this.inventory.updateGraphicalArmorPreview(c)
        },
        ...
        prepareForBattle: function() {
            this.healthBar.set(GameData.player.hp[0], GameData.player.hp[1]);
            $.each(["skills", "magic", "items"], function(b, c) {
                dom.find("#battle-sequence-popup ." + c + " ul.list").innerHTML = "";
                $.each(GameData.player.inventory[c], function(d, e) {
                    new BattleItem(e, c).add()
                })
            })
        }
    };
...
var Enemy = (function() {
    c.prototype = {
        startAttacking: function() {
            ...
            this.attackInterval = setInterval(this.attack.bind(this), this.enemyInformation.attack_interval)
        },
        attack: function() {
            var e = this.pickAttack();
            var f = this;
            window.currentBattle.eventEngine.add({
                message: (this.enemyInformation.name + " attacked with " + e.name),
                perform: function() {
                    f.attackWith(e)
                },
                eventTime: 2000
        ...
        pickAttack: function() {
            var e = [];
            for (var g in this.enemyInformation.attacks) {
                for (var f = 0; f < this.enemyInformation.attacks[g].probability; f++) {
                    e.push(this.enemyInformation.attacks[g])
                }
            }
            picked_attack = Math.round(Math.random() * (e.length - 1));
            return e[picked_attack]
        },
        attackWith: function(e) {
            window.currentGame.player.looseHealth(this.calculateAttackDamage(e));
            this.attackHoldBar.resetBar()
        },
        calculateAttackDamage: function(e) {
            return (e.damage - (e.damage * window.currentGame.player.armor().damage_reduction))
        },
        getEnemyStats: function() {
            return Enemies[this.identifier]
        },
        looseHealth: function(e) {
            this.enemyInformation.health -= e;
    ...
    function a() {
        var e = this;
        $.each(["experience", "stats", "items"], function(f, g) {
            if (e.enemyInformation.rewards[g]) {
                new Rewarder(g, e.enemyInformation.rewards).reward()
            }
        })
    }
    ...
    function c(e, f) {
        this.identifier = e;
        this.callbacks = f;
        this.enemyPre = dom.find(".enemies #" + e);
...
Item.prototype = {
    ...
    addParts: function() {
        var a = this;
        $.each(this.item, function(b) {
            a.item[b].style.display = "inline";
            a.item[b].onclick = function() {
                a.onClickMethod()
            }
        })
    },
    clearOnClickMethod: function() {
        ...
        $.each(this.item, function(b) {
            a.item[b].style.cursor = "default"
        })
    },
    removeParts: function() {
        var a = this;
        $.each(this.removals, function(b) {
            a.removals[b].style.display = "none"
        })
    }
};

function Item(a, b) {
    this.item = dom.findClass(a);
    this.removals = dom.findClass(a + "-remove");
    this.onClickMethod = b
}
...
Rewarder.prototype = {
    ...
    rewardSingleItem: function(b, c) {
        var a = this;
        window.currentBattle.eventEngine.add({
            message: a.rewardMessage(c),
            timeOut: 2000
        });
        this[this.typeOfReward + "RewardCallback"](c)
    },
    rewardMessage: function(b) {
        var a = "You receive ";
        if (this.typeOfReward == "stats") {
            ...
            if (this.typeOfReward == "items") {
                a += ("a " + b)
            } else {
                a += this.rewards[b] + " experience"
            }
        }
        return a
    },
    statsRewardCallback: function(a) {
        window.currentStats.increaseStat(a, this.rewards[a])
    },
    itemsRewardCallback: function(c) {
        var a = this.rewards[c];
        switch (c) {
            case "weapon":
                var b = new Weapon(a);
                window.currentGame.player.inventory.addItem("weapons", b);
                break;
            case "item":
                var b = new InventoryItem(a, "items");
                window.currentGame.player.inventory.addItem("items", b);
                break;
            case "map":
                GameData.player.map = a;
                break
        }
    },
    experienceRewardCallback: function(a) {
        window.currentGame.callbacks.experienceCallbacks.increaseExperience(this.rewards[a])
    },
...
BattleEventEngine.prototype = {
    ...
    callEvent: function(a, b) {
        if (b.type) {
            window.Events[b.type].invoke()
        }
        if (b.perform) {
            b.perform()
        }
        if (b.message) {
            this.infoHeader.update(b.message)
        }
        clearTimeout(this.eventTimeout)
    }
};
...
var BattleControls = (function() {
    a.prototype = {
        ...
        addMenuOnKeyUpListeners: function() {
            ...
            document.onkeydown = function(c) {
                ...
                switch (c.keyCode) {
                    case 65:
                        b.closeAllMenus();
                        window.currentGame.player.attack(b.enemy);
                        break;
                    case 70:
                        b.closeAllMenus();
                        window.currentBattle.battlePopup.hide();
                        break;
                    case 73:
                        if (!b.itemsButton.classList.contains("disabled")) {
                            b.openMenu("items")
                        }
                        break;
                    case 77:
                        if (!b.magicButton.classList.contains("hide")) {
                            b.openMenu("magic")
                        }
                        break;
                    case 83:
                        if (!b.skillButton.classList.contains("hide")) {
                            b.openMenu("skills")
                        }
                        break
                }
        ...
        openMenu: function(b) {
            var c = dom.find(".battle-sequence-interface div." + b);
        ...
        closeMenu: function(b, c) {
            dom.find(".battle-sequence-interface div." + c).style.display = "none"
        },
        closeAllMenus: function() {
            var b = ["items", "skills", "magic"];
            $.each(b, this.closeMenu.bind(this))
        },
...
BattleInfoHeader.prototype = {
    update: function(a) {
        this.infoHeader.innerHTML = a;
        this.showText()
    },
    showText: function() {
        clearTimeout(this.messageTimeout);
        move(this.infoHeader).set("opacity", 1).duration(0).end(this.endMessageCallback.bind(this))
    },
    ...
    hide: function() {
        move(this.infoHeader).duration(200).set("opacity", 0).end(self.clear);
        clearTimeout(this.messageTimeout)
    },
    clear: function() {
...
Battle.prototype = {
    ...
    controls: {
        ...
        enable: function() {
            window.currentGame.player.attackBar.resetBar(this.battleControls.enable.bind(this.battleControls))
        },
        disable: function() {
...
function Battle(a, b, c) {
    this.enemy = a;
    this.startCallback = b || function() {};
    this.endCallback = c || function() {};
...
ClickArea.prototype = {
    ...
    enable: function() {
        var a = this;
        this.applyMethodToclickParts(function(b, c) {
            c.onclick = a.clickAreaMethod.bind(a)
        })
    },
    disable: function() {
        this.applyMethodToclickParts(function(a, b) {
            b.onclick = null
        })
    },
    applyMethodToclickParts: function(a) {
        $.each(this.clickElement, a.bind(this))
    }
};

function ClickArea(b, a, c) {
    this.identifier = b;
    this.clickMethod = a || function() {};
    this.arguments = c || [];
    this.clickElement = dom.find(b, true)
}
var Level = (function() {
    l.prototype = {
        addToGame: function() {
        ...
        setClickMethodsToLevel: function() {
            $.each(this.clickAreas, d.bind(this))
        }
    };
    ...
    function g() {
        if (window.currentLevel) {
            i.bind(window.currentLevel)();
            a.bind(window.currentLevel)();
            k.bind(window.currentLevel)();
    ...
    function d(o, p) {
        var n = $.methodize(p);
        new ClickArea(p, this.clickMethods[n]).toggle()
    }
    ...
    function l(n, o) {
        this.identifier = n;
        this.mapSpot = o || n;
        this.levelDom = dom.find("#game-levels #" + n);
        this.moduleName = $.constantize(n);
        this.pointOnMap = m.bind(this)();
        this.levelModule = h.bind(this)();
        this.clickAreas = e.bind(this)();
        this.clickMethods = j.bind(this)()
    }
    return l
})();
var Game = (function() {
    ...
    d.prototype = {
        initialize: function() {
            if ($.isBrowserCompatible()) {
                ...
                g = GameStorage.get("koo-koo-island-gid") || $.guid();
                i.call(this);
                a.call(this);
                m.call(this);
                e.call(this);
        ...
        save: function() {
            ...
            GameStorage.store(g, this.getCurrentGame())
        },
        loadGame: function(o) {
            GameStorage.store(g, o);
            window.GameData = JSON.parse(atob(GameStorage.get(g)));
            h.call(this)
        },
        ...
        checkProgressOn: function(o) {
            return GameData.progress[o] == 1
        }
    };
    ...
    function i() {
        this.levels = {};
        var o = this;
        for (var p in window.Levels) {
            this.levels[p] = new Level(p);
            $.each(window.Levels[p], function(r, q) {
                o.levels[q] = new Level(q, p)
            })
        }
    }
    ...
    function e() {
        if (!GameStorage.keyExists("koo-koo-island-gid")) {
            GameStorage.store("koo-koo-island-gid", g);
            this.save()
        }
    }
    ...
    function j() {
        if (GameData.settings.autoSaveEnabled) {
            c = setInterval(this.save.bind(this), k)
        } else {
            clearInterval(c)
        }
    }
    ...
    function n() {
        var o = this;
        $.each(Object.keys(window.GameData.progress), function(q, p) {
            if (o.checkProgressOn(p)) {
                o.callbacks.loadCallbacks[p]()
            }
        })
    }
    ...
    function b() {
        var o = this;
        $.each(["seashell", "oyster", "wood"], function(p, q) {
            if (window.GameData.player[q + "s"] > 0) {
                o.callbacks.loadCallbacks.show_stat(q)
            }
        })
    }
...
Controls.prototype = {
    ...
    initializeLoadButton: function() {
        var a = new Popup("load-game-popup", this.load.initializeLoadPopupButtons.bind(this), this.load.disableLoadPopupButtons.bind(this));
    ...
    load: {
        initializeLoadPopupButtons: function() {
            ...
            this.getCurrentSaveGame.onclick = function() {
                var b = window.currentGame.getCurrentGame();
                a.loadGameForm.innerHTML = b
            };
            this.loadGameButton.onclick = function() {
                var b = confirm("Are you sure you want to load this game?");
                if (b) {
                    window.currentGame.loadGame(a.loadGameForm.value);
